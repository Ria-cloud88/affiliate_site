...
ARTICLES = [
    ...
    ("2026-04-03-gemini-guide",          "google,artificial-intelligence,technology"),
    ("2026-04-03-midjourney-guide",      "art,digital,creative"),
    ("2026-04-03-make-guide",            "automation,workflow,technology"),
    ("2026-04-03-video-editing-fukugyou","video,editing,computer"),
    ("2026-04-03-kindle-publishing",     "book,publishing,reading"),
    ("2026-04-03-twitter-x-fukugyou",   "social-media,phone,marketing"),
    ("2026-04-03-keyboard-comparison",  "keyboard,technology,office"),
    ("2026-04-03-mobile-battery-comparison","battery,phone,charging"),
    ("2026-04-03-remote-work-setup",    "office,desk,workspace"),
    ("2026-04-03-kindle-unlimited",     "books,reading,library"),
    ("2026-04-03-task-management-app",  "productivity,planning,calendar"),
    ("2026-04-03-gas-guide",            "code,programming,google"),
    ("2026-04-03-canva-guide",          "design,creative,art"),
    ("2026-04-03-vpn-comparison",       "security,internet,privacy"),
    ("2026-04-03-english-learning-app", "education,language,learning"),
    ("2026-04-03-portable-monitor",     "monitor,technology,laptop"),
    ("2026-04-03-sleep-app",            "sleep,health,wellness"),
    ("2026-04-03-python-automation",    "programming,code,python"),
    ("2026-04-03-freelance-tips",       "freelance,laptop,work"),
    ("2026-04-03-web-camera-comparison","camera,video,technology"),
]
